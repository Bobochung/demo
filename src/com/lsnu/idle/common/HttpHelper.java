...
import com.lsnu.idle.campus_life.ShopInfoActivity;
...
public final class HttpHelper {
	 ...
	 *           == 0L) { int bytes = read(); if (bytes < 0) { break; // 读到文件结束
	 *           } else { bytesSkipped = 1; // 读一个字节 } } totalBytesSkipped +=
