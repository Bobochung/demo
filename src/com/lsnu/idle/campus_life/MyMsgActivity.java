...
import com.lsnu.idle.adapter.MessageAdapter;
...
public class MyMsgActivity extends Activity implements UpdateHandler{
	...
	private List<com.lsnu.idle.entity.Message> listDatas = new ArrayList<com.lsnu.idle.entity.Message>();
		...
		HttpHelper.asyncPost(Constants.URL + "/second-hand/msg_list.do",
				params, new Callback() {
					...
					public void dataLoaded(Message msg) {
						...
						PageModel<com.lsnu.idle.entity.Message> pm = PageModel.jsonConvertMsg(json);
