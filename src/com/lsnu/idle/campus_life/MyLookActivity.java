...
import com.lsnu.idle.adapter.LookListAdapter;
...
public class MyLookActivity extends Activity implements UpdateHandler {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent =  new Intent(MyLookActivity.this,MainActivity.class);
		...
		list_all.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				final Dialog dialog = new Dialog(MyLookActivity.this,
				...
				ok.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						HttpHelper.asyncPost(Constants.URL + "/second-hand/look_delete.do", params, new Callback() {
							...
							public void dataLoaded(Message msg) {
								if(HttpStatus.SC_OK != msg.what){
									...
									Toast.makeText(MyLookActivity.this,
											msg.obj.toString(),
		...
		list_school.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(MyLookActivity.this,
						LookActivity.class);
